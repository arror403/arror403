...
A privacy-centric RAG system. Designed to allow users to query private documents using local LLMs without data ever leaving the machine. Runs without requiring internet connection.
...
### Contact
[Email](mailto:doggie_geek@proton.me)
